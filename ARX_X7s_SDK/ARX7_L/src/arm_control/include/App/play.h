...
public:
    ...
    float replay_start_pos[8]; // base_yaw x y z r p y
    float start_target_pos[8]; //6 debug
    float replay_joint_pos_temp[8];
    ...
    float read_init_pos[8]={0};
    float read_end_pos[8]={0};
