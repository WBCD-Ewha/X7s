...
# gnome-terminal -t "ARX7_L_Joint" -x  bash -c "cd ${workspace}/ARX7_L_Joint; rm -rf build devel .catkin_workspace src/CMakeLists.txt; catkin_make clean ;catkin_make; exec bash;"

# gnome-terminal -t "ARX7_R_Joint" -x  bash -c "cd ${workspace}/ARX7_R_Joint; rm -rf build devel .catkin_workspace src/CMakeLists.txt; catkin_make clean ;catkin_make; exec bash; "
