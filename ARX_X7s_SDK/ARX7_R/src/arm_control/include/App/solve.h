...
public:
    ...
    float J13_KP=150,J13_KD=10; //6
    float J1_KP=300,J1_KD=15; //240 3  //6  240 10
    float target_pos_temps[7]={};

    int calc_init=0;
    float joint_control_pos_t[7]={};
    
    float lower_bound_sim[7] = { -2.09439  , -1.5, -1.5 ,-1.5 , -1.2  , -1.57  ,-1.57};
    float upper_bound_sim[7] = { 2.09439   ,  0.3,  1.5 , 0.7854 ,  1.2 , 0.7854 , 1.57};
    float r_lower_bound_sim[7] ={ -2.09439 , -0.3, -1.5 , -0.7854 , -1.2  , -0.7854,-1.57};
    float r_upper_bound_sim[7] = { 2.09439 , 1.5,  1.5 , 1.5,   1.2  , 1.57   , 1.57};
