...
public:
    ...
    float current_pos[8] = {};
    float current_vel[8] = {0.0};
    float current_torque[8] = {0.0f};
    float target_pos[8] = {0.0f}, last_target_pos[8] = {0.0f};
    float gripper_pos[1]={0};
    float target_pos_temp[8] = {0.0f};
    float target_vel[8] = {0.0f};
    float ros_control_pos[8] ={};
    float ros_control_pos_t[8] ={};
    float ros_control_vel[8] ={};
    float ros_control_cur[8] ={};
    ...
    command limit_cmd();
    float gripper_flag=0,gripper_flag_t=0;
