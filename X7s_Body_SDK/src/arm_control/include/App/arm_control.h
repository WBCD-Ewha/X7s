...
public:
    ...
    void set_zero(void);
    void update(void);
    void update_real(int lift_mode );
    void motor_control();
    void joint_control();
    ...
    float motor_send_out=0;
    float set_high=0,set_high_t=0,set_high_t1=0;
    float lift_total_pos=0,lift_total_pos_last=0;
    int round_cnt = 0;


    int head_starting = 1;
    float send_head_pos[2] = {0,0};
    float send_body_pos[3] = {0,0};
    float head_arrived = 0;
    int head_init_flag = 0;
    float head_pos[2]={};
    void update_head( );
    void head_init();


    float arx_ros_vel[4]={0,0,0,0};
    float ros_chx=0,ros_chz=0,ros_chy=0;
    int chassis_mode=0,chassis_mode1=0,chassis_mode2=0;
    int  set_vx=0,set_vz=0,set_vy=0,set_chy=0,set_chx=0,set_chz=0,set_mode=0;
    void update_chassis();
