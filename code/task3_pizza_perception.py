...
from ros_sender import send_single_pose, send_moved_single_pose, is_action_fin
...
def main():
    ...
    print(f"task2: grasp pizza action succeed: {action_fin1}")
    rospy.sleep(2.0)
    ...
    if action_fin1:
        ...
        print(f"task2: drop pizza action succeed: {action_fin2}")
